...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-06-27 18:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ecbcfa10-feb0-459d-ad48-c007e2bcf70a.git
$ cd ecbcfa10-feb0-459d-ad48-c007e2bcf70a
```
